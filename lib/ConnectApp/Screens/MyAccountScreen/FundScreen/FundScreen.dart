...
import 'package:connect/ConnectApp/Models/FundPayInModel/FundPayInModel.dart';
import 'package:connect/ConnectApp/Models/FundPayOutModel/FundPayOutModel.dart';
import 'package:connect/ConnectApp/Screens/MyAccountScreen/FundScreen/FundPayInRequestScreen.dart';
import 'package:connect/ConnectApp/Screens/MyAccountScreen/FundScreen/FundPayOutRequestScreen.dart';
import 'package:connect/ConnectApp/Screens/MyAccountScreen/FundScreen/PayInScreen.dart';
import 'package:connect/ConnectApp/Screens/MyAccountScreen/FundScreen/PayOutScreen.dart';
                                    ...
                                    itemBuilder: (BuildContext context) {
                                      ...
                                      final bankNameMap =
                                          Map<String, String>.fromEntries(
                                              bankDetails!
                                                  .data.bankName.entries);
                                      final bankAccountNumberMap =
                                          Map<String, String>.fromEntries(
                                              bankDetails!.data
                                                  .bankAccountNumber.entries);

                                      List<PopupMenuEntry<BankDetail>>
                                          popupMenuItems = [];

                                      for (final nameEntry
                                          in bankNameMap.entries) {
                                        final accountNumber =
                                            bankAccountNumberMap[nameEntry.key];
              ...
              builder: (context, snapshot) {
                if (snapshot.connectionState == ConnectionState.waiting) {
                  ...
                  return Column(
                    ...
                    children: [
                      SvgPicture.asset("assets/icons/NoDataFound.svg",height: 50,width: 50,),
                      Center(
                        child: Utils.text(
                            text: "No data Found!",
                            color: kBlackColor,
