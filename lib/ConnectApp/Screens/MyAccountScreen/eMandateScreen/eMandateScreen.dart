...
import 'package:connect/ConnectApp/Screens/MyAccountScreen/FundScreen/FundScreen.dart';
                              ...
                              child: Row(
                                children: [
                                  ...
                                  PopupMenuButton<BankDetail>(
                                    icon: const Icon(Icons.arrow_drop_down_rounded, color: Color(0xFF00A9FF), size: 40,),
                                    color: Colors.white,
                        ...
                        child: Container(
                          ...
                          child: Padding(
                            ...
                            child: Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: [
                                SvgPicture.asset("assets/icons/OnlineEmandateIcon.svg",height: 28,width: 28,color: isOnlineEmandate ? const Color.fromRGBO(15, 63, 98, 1.0) : const Color.fromRGBO(55, 71, 79, 1.0)),
                                const SizedBox(
                                  width: 10,
                                ),
                                Utils.text(
                        ...
                        child: Container(
                          ...
                          child: Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                SvgPicture.asset("assets/icons/PhysicalEmandateIcon.svg",height: 30,width: 30,color: isOnlineEmandate ? const Color.fromRGBO(55, 71, 79, 1.0) : const Color.fromRGBO(15, 63, 98, 1.0)),
                                const SizedBox(
                                  width: 10,
                                ),
                                Utils.text(
