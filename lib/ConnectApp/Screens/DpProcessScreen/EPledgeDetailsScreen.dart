...
class Epledgedetailsscreen extends StatefulWidget {
  const Epledgedetailsscreen({super.key});

  @override
  State<Epledgedetailsscreen> createState() => _EpledgedetailsscreenState();
}

class _EpledgedetailsscreenState extends State<Epledgedetailsscreen> {
  dynamic arguments = Get.arguments;
  EPledgeFilteredDf? filteredDf;
  double? bidValue = 0.0;
  double minValue = 0.0;
  double maxValue = 0.0;
