...
class _KycDpLedgerScreenState extends State<KycDpLedgerScreen> {
  ...
  List<bool>? isShow;
  Future<DpLedgerReport>? futureDpLedgerReport;
  ...
  Future<void> _fetchLedgerReport() async {
    ...
    futureDpLedgerReport = BackOfficeApiService().fetchDpLedgerReport(
        token: Appvariablesbackoffice.token ?? "",
        clientCode: clientCodeController.text,
        toDate: toDate,
        fromDate: fromDate);

    futureDpLedgerReport?.then((data) {
      if (mounted) {
        setState(() {
          ...
          child: Column(
            children: [
              ...
              Visibility(
                ...
                child: Expanded(
                  child: FutureBuilder<DpLedgerReport>(
                    future: futureDpLedgerReport,
                    builder: (context, snapshot) {
                      if (snapshot.connectionState == ConnectionState.waiting) {
                        ...
                        return dpLedgerFilteredData.isNotEmpty
                            ? ListView.builder(
                                shrinkWrap: true,
                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    Row(
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        Utils
                                                                            .text(
                                                                          text: ledgerReport.receiveDate == ""
                                                                              ? "-"
                                                                              : ledgerReport.receiveDate,
                                                                          color:
                                                                              kBlackColor87,
                                                                          fontSize:
                                                                              13,
                                                                    ...
                                                                    Row(
                                                                      ...
                                                                      children: [
                                                                        Utils
                                                                            .text(
                                                                          text: ledgerReport.voucher == ""
                                                                              ? "-"
                                                                              : ledgerReport.voucher,
                                                                          color:
                                                                              kBlackColor87,
                                                                          fontSize:
                                                                              13,
                                                                    ...
                                                                    Row(
                                                                      ...
                                                                      children: [
                                                                        Utils
                                                                          ...
                                                                          color: ledgerReport.balance.startsWith("-")
                                                                              ? Colors.red
                                                                              : Colors.green,
                                                                          fontSize:
                                                                              13,
