...
class _FundscreenState extends State<Fundscreen> {
  ...
  void initState() {
    ...
    fetchFundPayIn("fund_payin");
    fetchFundPayIn("fund_payout");
    fetchBankDetails();
  }

  Future<void> fetchFundPayIn(String? type) async {
    futureFundPayin = ApiServices().fetchFundPayin(authToken: Appvariables.token, typeOfFund: type);
  }
